    ...
    public void sendEmail(NotificationDTO notificationDTO, User user) {
        ...
        try{
            ...
            if (notificationDTO.getTemplateName() != null){
                ...
                templateContext.setVariables(notificationDTO.getTemplateVariables());
                String htmlContent = templateEngine.process(notificationDTO.getTemplateName(), templateContext);
